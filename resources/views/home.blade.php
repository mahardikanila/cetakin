...
<head>
    ...
    <link href="{{asset('public/color/default.css')}}" rel="stylesheet">
    <link rel="shortcut icon" href="{{asset('public/img/cetakin_black.png')}}">
</head>
<body>
<!-- navbar -->
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <h1 class="brand"><a href="{{route('home')}}">Cetakin</a></h1>
                <!-- navigation -->
        ...
        <div class="row">
            <div class="span6 alignright flyLeft">
                <blockquote class="large">
                    Too much thinking? Just do it and print it!<cite>Nike</cite>
                </blockquote>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span4 offset1">
                <div>
                    <h2>Make your life easier through <strong>CETAKIN.COM</strong></h2>
                    <p>
                        Cetakin.com adalah platform yang menyediakan kemudahan dalam berbagai hal yang berhubungan
                        dengan percetakan. Melalui Cetakin.com anda bebas memilih lokasi beserta layanan yang diinginkan.
                    </p>
                </div>
            </div>
            <div class="span6">
        ...
        <div class="row">
            <div class="span3 animated-fast flyIn">
                <div class="service-box">
                    ...
                    <h2>Text Based</h2>
                    <p>
                        Skripsi, Laporan, Makalah, Sertifikat
                    </p>
                </div>
            </div>
            ...
            <div class="span12">
                <div id="portfolio-wrap">
                    ...
                    <div class="portfolio-item grid print photography">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]"
...
<section id="contact" class="section green">
    <div class="container">
        <h4>Get in Touch</h4>
        <p>
            Reque facer nostro et ius, cu persius mnesarchum disputando eam, clita prompta et mel vidisse phaedrum pri
            et. Facilisis posidonium ex his. Mutat iudico vis in, mea aeque tamquam scripserit an, mea eu ignota viderer
    ...
    <div class="container">
        <div class="row">
            <div class="span6 offset3">
                ...
                <p class="copyright">
                    &copy; Find.Co All rights reserved.
                <div class="credits">
                    <!--
